...
function createTextAnimation() {
  var geometry = generateTextGeometry("W", {
    size: 14,
    height: 0,
    font: "droid sans",
    weight: "bold",
...
function TextAnimation(textGeometry) {
  ...
  var material = new THREE.BAS.BasicAnimationMaterial({
    ...
    uniforms: {
      ...
      uDiffuse: { value: new THREE.Color("#ffffff") },
    },
    shaderFunctions: [THREE.BAS.ShaderChunk["cubic_bezier"], THREE.BAS.ShaderChunk["ease_out_cubic"]],
    shaderParameters: [
      "uniform float uTime;",
